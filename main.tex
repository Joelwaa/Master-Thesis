...
\begin{equation}\label{eq:hedging error}
    \Delta(H) = \inf_{\vartheta\in\mathcal{H}^u}\mathbb{E}[\left(H-\vartheta\bullet X\right)_T)^2]
\end{equation}
and in analogy to \parencite[Thm.~4.9.]{Buehler2018DeepHedging} we introduce
\begin{equation}\label{eq:M hedging error}
    \Delta^M(H) = \inf_{\vartheta\in\mathcal{H}^M}\mathbb{E}[\left(H-\vartheta\bullet X\right)_T)^2]
\end{equation}
...
\begin{proposition}[Discrete Deep Mean variance Hedging]\label{thm:discrete deep mean variance hedging}
    \begin{equation}
        \inf_{\vartheta\in\mathcal{H}^u}\mathbb{E}[\left(H-p_0-(\vartheta\bullet X)_T\right)^2]=\inf_{\vartheta\in\mathcal{NN}_{\infty}}\mathbb{E}[\left(H-p_0-(\vartheta\bullet X)_T\right)^2].
    \end{equation}
\end{proposition}
...
\begin{equation}
    \mathbb{E}[\left(H-p_0-(\vartheta\bullet X)_T\right)^2]=\sum_{\omega\in\Omega}\left(H(\omega)-p_0-(\vartheta\bullet X)_T(\omega)\right)^2\;,
\end{equation}
