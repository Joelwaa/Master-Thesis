...
\begin{definition}
    ...
    \begin{equation}
        \lVert M\rVert_{\mathcal{H}^p}\coloneqq \lVert M\rVert_{p}=\mathbb{E}[\sup_t|M_t|^p]^{1/p}\;,
    \end{equation}
    where \(\lVert\cdot\rVert_p\) denotes the \(L^p\)-norm. The \(\mathcal{H}^p\) is the space of martingales such that 
    \begin{equation}
